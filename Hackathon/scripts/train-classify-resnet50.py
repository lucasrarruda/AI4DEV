...
# === CONFIG ===
DATASET_DIR = "C:/Projects/AI4DEV/Hackathon/aws_icons_basic_class"
...
BALANCED_DATASET_DIR = "C:/Projects/AI4DEV/Hackathon/aws_icons_basic_class_balanced_resnet"
...
# === TREINAMENTO ===
print("⏳ Treinando classificador de grupo (ResNet50)...")
model.train()
...
torch.save(model.state_dict(), "modelo_group_classifier_resnet50.pth")
with open("modelo_group_classifier_classes_resnet50.txt", "w", encoding="utf-8") as f:
